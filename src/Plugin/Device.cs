...
namespace Plugin
{
    ...
    internal abstract class Device
    {
        ...
        /// <returns>Braking/powering demands of the device. 
        ///     - Negative for braking (lower than number of brake notches for emergency)
        ///     - 0 for coasting
        ///     - Positive for powering
        /// The lowest value is applied.</returns>
        internal abstract int? Elapse(ElapseData data);
